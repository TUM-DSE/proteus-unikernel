...
// #define SIGNAL_SIZE (25 * 1024 * 1024)
// #define SIGNAL_SIZE (5 * 1024 * 1024)
...
int main(int argc, char** argv) {
    if (argc != 3) {
        std::cout << "Usage: " << argv[0] << " <XCLBIN File>" << " <Signal Size [MB]>" << std::endl;
        return EXIT_FAILURE;
    }

    std::string binaryFile = argv[1];
    std::string signal_size_str = argv[2];
    int signal_size = std::stoi(signal_size_str) * (1024 * 1024) / sizeof(int);
    cl_int err;
    cl::CommandQueue q;
    cl::Context context;
    cl::Program program;
    ...
    // printf("Signal_Length=%u MB for %d iteration\n", size_in_bytes / (1024*1024), iterations);
    printf("Hostcode is done.\n");
