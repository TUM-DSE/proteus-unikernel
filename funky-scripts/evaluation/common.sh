...
VITIS_EXAMPLES_APPS=(cl_array_partition cl_burst_rw cl_dataflow_func cl_dataflow_subfunc cl_helloworld cl_lmem_2rw cl_loop_reorder cl_partition_cyclicblock cl_shift_register cl_systolic_array cl_wide_mem_rw)
